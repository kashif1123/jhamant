                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Pay Salary</h3>
                        </div>
                                    ...
                                    <div class="kt-section__body">
                                        ...
                                        <div class="form-group row">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control kt-select2 customer" id="kt_select2_1" name="param">
                                                            <option value="defaultsupplier" selected disabled>Select an Employee</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Month</label>
                                                    <input type="text" autocomplete="off" class="form-control salary_month"  placeholder="eg: January"/>
                                                    <span class="form-text error-alert text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                ...
                $(document).ready(function (e) {
                    ...
                    $(".save").click(function (e) {
                        ...
                        if (salary_month == '' || salary_month == null) {
                            $('#salary_month').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Please Enter Salary Month.').addClass('text-danger').show();
                        } else {
                            $('#salary_month').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        ...
                        if ($('.is-invalid').length<1) {
                            ...
                            $.ajax({
                                url: '{{ url("pay_receive/insert_salary") }}',
                                type: 'post',
                                data: {
