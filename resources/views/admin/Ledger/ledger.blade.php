                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group">
                                                    <select class="form-control kt-select2 ledger_of" id="kt_select2_2">
                                                            <option value="all" selected>All Ledger</option>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            $('#loadledgerbydate').click(function (e) {
                ...
                table.ajax.url("{{url('ledger/dtgetledgerbydatedetails')}}?min="+min+'&'+'max='+max+'&'+'ledger_of='+ledger_of+'&'+'ledger_of_label='+ledger_of_label).load().draw();
            });
        });
