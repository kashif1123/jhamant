                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Sale Report</h3>
                        </div>
                    ...
                    <div class="kt-portlet__body">
                        ...
                        <!-- /.box-header -->
                            <div class="box-body" style="overflow-x:auto;">
                                <table id="s_products" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Sr</th>
                                        <th>Invoice</th>
                                    ...
                                    <td></td>
                                    <td></td>
                                    <td class="s_f_total" style="background-color: #DADADA; font-weight: bold !important;"></td>
                                    <td></td>
                                    <td class="s_f_grand_total" style="background-color: #DADADA; font-weight: bold !important;"></td>
                                    <td class="s_f_paid" style="background-color: #DADADA; font-weight: bold !important;"></td>
                                    <td class="s_f_due" style="background-color: #DADADA; font-weight: bold !important;"></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                                    <td></td>
                        ...
                        <tr>
                            <td>
                                <table border="0" style="margin: auto;" class="header">
                                    <tr>
                                        <td  align="center" style="font-weight: bolder;font-size: 15pt; font-family: Arial, sans-serif">Duplicate Invoice</td>
                                    </tr>
                                    <tr>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.DataTable.Editor({
                ...
                fields: [
                    ...
                    {label: "Truck No:", name: "truck_no",type:"readonly"},
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('sale/dtgetallsale_customers') }}',
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Sale Report</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                ...
                columns:[
                    ...
                    {data:'employee_commission','name':'employee_commission'},
                    {data:'date','name':'date'},
            ...
            var s_table=  $('#s_products').DataTable({
                dom: "Blfrtip",
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('sale/dtgetallsale_suppliers') }}',
                // "columnDefs": [
                //     { "targets": [1,2,3,4], "searchable": false }
                // ],
                "paging"     : true,
            ...
            $(document).on('click','.print_duplicate',function (e) {
                var invoice_data= table.row($(this).closest('tr')).data();
                // alert(invoice_data)
                $.ajax({
                    url: '{{ url("sale/get_reprintdata") }}',
                    type: 'post',
                    data: {
                    ...
                    success: function (data) {
                        ...
                        $("#r_t_paid").text(invoice_data.paid);
