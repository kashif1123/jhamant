                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Sold Products</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('sale/dtgetshowallsale') }}',
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    '<tH style="text-align: center;">Date of sale</tH>' +
                                    '</tr>'
                                );
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">All Sold Products</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
