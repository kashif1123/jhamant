    ...
    <div class="kt-container  kt-grid__item kt-grid__item--fluid">
        <div class="row">
            <div class="col-lg-12">
                ...
                @if(isset($monthclose))
                        <form action=" {{url('monthclose/mini_monthly_close')}}" method="post">
                            {{csrf_field()}}
                            <div class="row" style="margin-bottom: 10px;margin-top: 10px;">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control month_date" id="kt_select2_1" name="dates">
                                        @foreach($month_closes as $month_close)
                                            <option value="{{$month_close->id}}">{{date('Y/m/d',strtotime($month_close->closing_date_from)).' --- '.date('Y/m/d',strtotime($month_close->closing_date_to))}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                {{--                            @endif--}}
                    ...
                    <div class="container" id="day_close_report">
                        ...
                        <div style="border: 1px solid black;border-radius: 4px;padding: 30px;" >
                            ...
                            <div style="font-weight:bolder;text-align: center;background-color: lightgrey;color: black;font-size: 20px;margin-bottom: 10px;">Mini Month Close Report</div>
                            @if($monthclose->total_profit > 0)
                            <h3>Great! We are in Profit This month</h3>
                            @else
                            <h3>Unfortunately We are in Loss This month</h3>
                            @endif
                            <div class="row">
                                        <div class="col-md-2 ml-3" style="text-align:center ;border: 1px solid grey; padding: 22px 36px;  margin: 12px">
                                            <h4>Total Profit/Loss: {{abs($monthclose->total_profit)}}.</h4>
                                        </div>
                                        <div class="col-md-2" style="text-align:center ;border: 1px solid grey; padding: 22px 36px;  margin: 12px">
                                            <h4>Reconciled Profit/Loss: {{$monthclose->total_reconciled}}.</h4>
                                        </div>
                                        <div class="col-md-2" style="text-align:center ;border: 1px solid grey; padding: 22px 36px;  margin: 12px">
                                            <h4>Stock Worth: {{$products_worth}}.</h4>
                                        </div>
                                        <div class="col-md-2" style="text-align:center ;border: 1px solid grey; padding: 22px 36px;  margin: 12px">
                                            <h4>Expenses: {{$total_expanses}}.</h4>
                                        </div>
                                        <div class="col-md-2" style="text-align:center ;border: 1px solid grey; padding: 22px 36px;  margin: 12px">
                                            <h4>Recovery: {{$receive_amounts}}.</h4>
                                        </div>
                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <table id="usertable" class="table table-bordered" >
                                                ...
                                                <tr style="background-color: rgba(165,165,171,0.25)">
                                                    <td>Total Sale Quantity</td>
                                                    <td>Total Sale Amount</td>
                                                    <td>Credit Sale Amount </td>
                                                    <td>Cash Sale Amount </td>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                    <td>{{$total_sale}}</td>
