                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Bank Accounts</h3>
                        </div>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ...
                fields: [
                    ...
                    {label: "branch_code:", name: "branch_code"},
                    {label: "contact:", name: "contact"},
                    {label: "account:", name: "account"},
                    {label: "Opening Balance:", name: "opening_balance",type:"readonly"},
                    {label: "Current Balance:", name: "current_balance",type:"readonly"},
                        ...
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    // '<th style="text-align: center;">All In</th>' +
                                    // '<th style="text-align: center;">All Out</th>' +
