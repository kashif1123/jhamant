                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Money Transfer</h3>
                        </div>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control selectaccount_from" >
                                                            <option value="defaultaccount" selected disabled>Select Account</option>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text"class="form-control" readonly id="account_balance_from" placeholder="Account Balance">
                                                    </div>
                                                    <span class="form-text error-alert text-danger"></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="form-control selectaccount_to" >
                                                            <option value="defaultaccount" selected disabled>Select Account</option>
                                                            @foreach($accounts as $account)
                                                                <option value="{{$account->id}}">{{$account->branch_name}}</option>
                                                            @endforeach
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label>Account Balance</label>
                                                    <div class="input-group">
                                                        <input type="text"class="form-control" readonly id="account_balance_to" placeholder="Account Balance">
                                                    </div>
                                                    <span class="form-text error-alert text-danger"></span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    {{--<div class="input-group">--}}
                                                    <input type="text" autocomplete="off" value="0" class="form-control" id="amount" placeholder="Transfer Amount"
        ...
        @section('scripts')
            ...
            <script>
                $(document).ready(function (e) {
                    $('.selectaccount_from').select2();
                    $('.selectaccount_to').select2();

                    $('.selectaccount_from').change(function (e) {
                        var account=$('.selectaccount_from').val();
                        $.ajax({
                            ...
                            success: function (data) {
                                console.log(data);
                                if (data.data !== null) {
                                    $('#account_balance_from').val(data.data.current_balance);
                                }
                            },
                    ...
                    $('.selectaccount_to').change(function (e) {
                        var account=$('.selectaccount_to').val();
                        $.ajax({
                            url: '{{ url("expense/fetch_account_balance") }}',
                            type: 'post',
                            data: {
                            ...
                            success: function (data) {
                                console.log(data);
                                if (data.data !== null) {
                                    $('#account_balance_to').val(data.data.current_balance);
                                }
                            },
                            error: function (error) {
                                console.log(error.responseText);
                    ...
                    $("#saveexpense").click(function (e) {
                        var account_from=$('.selectaccount_from').val();
                        var account_to=$('.selectaccount_to').val();
                        var date=$('.expensedate').val();
                        var amount=parseFloat($('#amount').val());
                        var description=$('#description').val();
                        var account_from_balance=$('#account_balance_from').val();
                        //validations


                        if (account_from == 'defaultaccount' || account_from == null) {
                            $('.selectaccount_from').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Please Select Paying Account.').addClass('text-danger').show();
                        } else {
                            $('.selectaccount_from').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        if (account_to == 'defaultaccount' || account_to == null) {
                            $('.selectaccount_to').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Please Select Receiving Account.').addClass('text-danger').show();
                        } else {
                            $('.selectaccount_to').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        ...
                        if (amount == '0' || amount == '' || amount == null) {
                            $('#amount').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Amount is Required.').addClass('text-danger').show();}
                        else {
                            $('#amount').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        if (parseFloat(amount) >  parseFloat(account_from_balance)) {
                            $('#amount').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Not enough Money in Paying account.').addClass('text-danger').show();}
                        else {
                            $('#amount').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        ...
                        if ($('.is-invalid').length<1) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $('.selectaccount_from').removeClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                                    $('.selectaccount_to').removeClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                                    ...
                                    $('.selectaccount_from').val('defaultaccount').change();
                                    $('.selectaccount_to').val('defaultaccount').change();
                                    $('#account_balance_from').val('');
                                    $('#account_balance_to').val('');
                                    $('#amount').val(0);
                                    $('#description').val('');
