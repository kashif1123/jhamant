                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Account Top up Report</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ajax: "{{ url('bank/dtposttopup') }}",
                table: "#installmentplan",
                display: "bootstrap",
                idSrc:'id',
                fields: [
                    {label: "Account:", name: "branch_name",type:"readonly"},
                    {label: "Last Balance:", name: "last_balance",type:"readonly"},
                    {label: "Date:", name: "topup_date",type:"datetime"},
                    {label: "Top Up Amount:", name: "topupamount",type:"readonly"},
            ...
            var table=  $('#installmentplan').DataTable({
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    '<th style="text-align: center;">Top Up Date</th>' +
                                    '<th style="text-align: center;">Top Up Amount</th>' +
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Account Top Up Report</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                ...
                columns:[
                    ...
                    {data:'topup_date','name':'topup_date'},
            ...
            $('.loaddatabydate').click(function (e) {
                ...
                table.ajax.url('{{url('bank/dtgetshowtopup_date')}}?min='+min+'&'+'max='+max).load()
            });
