                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Purchase Returns Report</h3>
                        </div>
                            ...
                            <div class="box-body" style="overflow-x:auto;">
                                <table id="products" class="table table-bordered table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <th>Return Date</th>
                                        <th>Total Receiving Amount</th>
                                        <th>Amount Received At Spot</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    </tbody>
        ...
        $(document).ready(function (e) {
            ...
            {{--editor =  new $.fn.DataTable.Editor({--}}
                ...
                {{--fields: [--}}
                    ...
                    {{--{label: "Category:", name: "c_name",type:"readonly"},--}}
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "bserverSide": true,
                "ajax": '{{ url('purchase/dtgetshow_p_return') }}',
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    '<th style="text-align: center;">Total Receiving Amount</th>' +
                                    '<th style="text-align: center;">Amount Received at Spot</th>' +
                                    '</tr>'
                                );
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Purchase Return Report</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                ...
                columns:[
                    ...
                    {data:'total_receiving_amount','name':'total_receiving_amount'},
