                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Customer Invoices</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            {{--editor =  new $.fn.DataTable.Editor({--}}
                ...
                {{--idSrc:'id',--}}
                {{--fields: [--}}
                    {{--{label: "Name:", name: "customers.name",type:"readonly"},--}}
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('supplier/dtgetshowcustomerinvoices') }}',
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Customer Invoices</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
            ...
            $('.loaddatabydate').click(function (e) {
                ...
                table.ajax.url('{{url('supplier/dtgetshowcustomerinvoices_date')}}?min='+min+'&'+'max='+max).load()
            });
