                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Supplier Invoices</h3>
                        </div>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.DataTable.Editor({
                ...
                fields: [
                    ...
                    {label: "Invoice:", name: "invoice",type:"readonly"},
                    {label: "Total :", name: "total",type:"readonly"},
                    {label: "Discount:", name: "discount",type:"readonly"},
                    {label: "Grand Total:", name: "grand_total",type:"readonly"},
                    {label: "Paid :", name: "paid",type:"readonly"},
                    {label: "Due:", name: "due",type:"readonly"},
                    {label: "Date:", name: "date_of_purchase",type:"readonly"},
                ]
            });
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('supplier/dtgetshowsupplierinvoices') }}',
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Supplier Invoices</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
            ...
            $('.loaddatabydate').click(function (e) {
                ...
                table.ajax.url('{{url('supplier/dtgetshowsupplierinvoices_date')}}?min='+min+'&'+'max='+max).load()
            });
