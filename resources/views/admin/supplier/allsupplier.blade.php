                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Suppliers</h3>
                        </div>
...
{{--                                        <th>Delete</th>--}}
                                    ...
                                    @foreach($data as $supplier)
                                        <tr>
                                            ...
                                            <td>{{last_balance($supplier['id'],'supplier')}}</td>
                                            <td>{{$supplier['registration_date']}}</td>
                                            <td>{{$supplier['type']}}</td>
                                            <td>{{$supplier['description']}}</td>
{{--                                            <td><button class="editor_remove form-control btn btn-danger"><i class="fa fa-trash"></i></button></td>--}}
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.DataTable.Editor({
                ajax: "{{ url('supplier/dtpost_s_contacts') }}",
                table: "#contacts",
                display: "bootstrap",
                idSrc:'id',
                fields: [
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": false,
{{--                "ajax": '{{ url('supplier/dtgetshowsupplier') }}',--}}
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">All Suppliers</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                ...
                {{--        name: 'delete',--}}
                {{--        className: "center",--}}
                {{--        defaultContent: '<button class="editor_remove form-control btn btn-danger"><i class="fa fa-trash"></i></button>',--}}
                {{--        orderable: false--}}
                {{--    },--}}
                {{--]--}}
            });
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h4 class="m-0 mb-2" style="font-family: sans-serif;">{{credentials()->owner_name}}</h4>\n' +
                                '                                        <h4 class="m-0" style="margin-bottom: 2px; font-family: sans-serif;">{{credentials()->phone1.' . '.credentials()->phone2.' . '.credentials()->phone3}}</h4>\n' +
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Supplier Contact Numbers</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                                // '                                        <h5 class="ml-4 m-0" style="font-family: sans-serif;">Fertilizers Dealers</h5>\n' +
                                '                                        <h1 class="ml-4 m-0" style="font-family: sans-serif;">{{credentials()->company_name}}</h1>\n' +
