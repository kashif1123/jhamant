                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Employees</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.DataTable.Editor({
                ajax: "{{ url('supplier/dtposteditemployee') }}",
                table: "#products",
                display: "bootstrap",
                idSrc:'id',
                fields: [
            ...
            editer2=  new $.fn.DataTable.Editor({
                ajax: "{{ url('supplier/dtpost_e_contacts') }}",
                table: "#contacts",
                display: "bootstrap",
                idSrc:'id',
                fields: [
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('supplier/dtgetshowemployees') }}',
                // "columnDefs": [
            ...
            $(document).on('click','.editor_remove',function (e) {
                ...
                $.ajax({
                    url: '{{ url("supplier/delete_employee") }}',
                    type: 'post',
                    data: {
                        'id': data.id,
                    ...
                    success: function (data) {
                        ...
                        if(data.message){
                            ...
                            $.notify('Employee Was deleted successfully..', {
                                type: 'success',
                                allow_dismiss: false,
            ...
            var table2=  $('#contacts').DataTable({
                ...
                "bprocessing": true,
                "bserverSide": true,
                "ajax": '{{ url('supplier/dtget_e_contacts') }}',
                // "columnDefs": [
                //     { "targets": [1,2,3,4], "searchable": false }
                // ],
                "paging"     : true,
