                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Employee Commission Report</h3>
                        </div>
    ...
    <script>
        $(document).ready(function (e) {
            ...
            var table=  $('#installmentplan').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('supplier/dtget_employee_commission') }}',
                "columnDefs": [
                        ...
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    '<th style="text-align: center;">Employee Commission</th>' +
                                    '</tr>'
                                );
            ...
            $('.loaddatabydate').click(function (e) {
                ...
                table.ajax.url('{{url('supplier/dtget_employee_commission_date')}}?min='+min+'&'+'max='+max).load()
            });
