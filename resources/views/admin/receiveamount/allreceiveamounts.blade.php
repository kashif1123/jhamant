                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Received Amounts</h3>
                        </div>
...
{{--                                        <th>Delete</th>--}}
                    ...
                    <div class="kt-portlet__body">
                        <div class="box">
                        <div class="box-header">
                        <h3 class="box-title">Owners Report </h3>
                        </div>
                        <!-- /.box-header -->
                            <div class="box-body" style="overflow-x:auto;">
                                <table id="products3" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Sr</th>
                                        <th>Owner Name</th>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ajax: "{{ url('pay_receive/dtpostshowallreceived') }}",
                table: "#products",
                display: "bootstrap",
                idSrc:'id',
                fields: [
                    {label: "Person Name:", name: "branch_code",type:"readonly"},
                    {label: "Paying Account:", name: "branch_name",type:"readonly"},
                    {label: "Date:", name: "date",type:"readonly"},
                    {label: "Receiving Amount:", name: "receiving_amount",type:"readonly"},
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('pay_receive/dtgetshowallreceived') }}',
                // "columnDefs": [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        customize: function ( win ) {
                            ...
                            $(win.document.body).find( 'table' )
                                .prepend (
                                    ...
                                    '<th style="text-align: center;">Receiving Account</th>' +
                                    '<th style="text-align: center;">Date</th>' +
                                    '<th style="text-align: center;">Receiving Amount</th>' +
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Supplier Received Amounts</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
            ...
            var table2=  $('#products2').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('pay_receive/dtgetshowallreceived2') }}',
                // "columnDefs": [
                //     { "targets": [1,2,3,4], "searchable": false }
                // ],
                "paging"     : true,
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h4 class="m-0 mb-2" style="font-family: sans-serif;">{{credentials()->owner_name}}</h4>\n' +
                                '                                        <h4 class="m-0" style="margin-bottom: 2px; font-family: sans-serif;">{{credentials()->phone1.' . '.credentials()->phone2.' . '.credentials()->phone3}}</h4>\n' +
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Customer Received Amounts</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
                                // '                                        <h5 class="ml-4 m-0" style="font-family: sans-serif;">Fertilizers Dealers</h5>\n' +
                                '                                        <h1 class="ml-4 m-0" style="font-family: sans-serif;">{{credentials()->company_name}}</h1>\n' +
            ...
            var table3=  $('#products3').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('pay_receive/dtgetshowallreceived3') }}',
                // "columnDefs": [
                //     { "targets": [1,2,3,4], "searchable": false }
                // ],
                "paging"     : true,
            ...
            $(document).on('click','.editor_remove_customer',function (e) {
                ...
                $.ajax({
                    url: '{{ url("pay_receive/delete_customer_received") }}',
                    type: 'post',
                    data: {
                        'id': data.id,
                        '_token': '{{csrf_token()}}'
            ...
            $(document).on('click','.editor_remove_supplier',function (e) {
                ...
                $.ajax({
                    url: '{{ url("pay_receive/delete_supplier_received") }}',
                    type: 'post',
                    data: {
                        'id': data.id,
                        '_token': '{{csrf_token()}}'
            ...
            $(document).on('click','.editor_remove_owner',function (e) {
                ...
                $.ajax({
                    url: '{{ url("pay_receive/delete_owner_received") }}',
                    type: 'post',
                    data: {
                        'id': data.id,
                        '_token': '{{csrf_token()}}'
