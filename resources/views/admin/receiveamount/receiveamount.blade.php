                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Receive from Accounts</h3>
                        </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" value="0" class="form-control" autocomplete="off" id="p_amount" placeholder="Enter Paying Amount"
                ...
                $(document).ready(function (e) {
                            ...
                            $.ajax({
                                ...
                                success: function (data) {
                                    ...
                                    $('.supp_cust_balance_toggle').append('<div class="form-group">\n' +
                                        ...
                                        '                                                    <span class="form-text error-alert text-danger"></span>\n' +
                                        '                                                </div>');
                                    $('.customer').append('<option value="defaultsupplier">Select an Owner</option>');
                                    for(var q=0;q<data.data.length;q++){
                                        $('.customer').append('<option value="'+data.data[q].id+'">'+data.data[q].name+'</option>');
                                    }
                                },
                    ...
                    $(".save").click(function (e) {
                        ...
                        if ($('.is-invalid').length<1) {
                            ...
                            $.ajax({
                                url: '{{ url("pay_receive/insert_receiveamount") }}',
                                type: 'post',
                                data: {
                                    'paying_date': paying_date,
                                    'person_id': person_id,
                                    'account_type': account_type,
                                    'receiving_amount': paying_amount,
                                ...
                                success: function (data) {
                                    ...
                                    $('#p_amount').val('');
                                    var selected_account_id=$(".account").val();
                                    $.ajax({
                                        url:'{{url('pay_receive/fetch_account_balance')}}',
                                        type: 'post',
                                        data:{'id':selected_account_id ,'_token':'{{csrf_token()}}'},
                                        success:function (data) {
                                            console.log(data);
                                            if (data.data !== null){
                                                $('#account_balance').val(data.data.current_balance);
                                    ...
                                    // $('.account').change('defaultaccount').val('');
                                    // $('.customer').change('defaultsupplier').val('');
                                    $('#description').val('');
