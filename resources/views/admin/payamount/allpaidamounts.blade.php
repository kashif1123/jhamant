                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">All Paid Amounts</h3>
                        </div>
...
{{--                                        <th>Delete</th>--}}
                        ...
                        <div class="box">
                        <div class="box-header">
                        <h3 class="box-title">Owner Report </h3>
                        </div>
                        <!-- /.box-header -->
                            <div class="box-body" style="overflow-x:auto;">
                                <table id="products4" class="table table-bordered table-striped">
                                    <thead>
                                    <tr>
                                        <th>Sr</th>
                                        <th>Owner Name</th>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            var table=  $('#products').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('pay_receive/dtgetshowallpaid') }}',
                // "columnDefs": [
