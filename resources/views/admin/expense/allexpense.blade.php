    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ajax: "{{ url('expense/dtpostexpensedetail') }}",
            ...
            var table=  $('#installmentplan').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('expense/dtgetexpensedetails') }}',
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">Expense Report</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
