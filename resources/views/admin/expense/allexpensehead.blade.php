                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Expense Heads</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.DataTable.Editor({
                ajax: "{{ url('expense/dtpostexpenseheads') }}",
                table: "#installmentplan",
                display: "bootstrap",
                idSrc:'id',
                fields: [
                    {label: "Expense Head:", name: "expense_head"},
                 ]
            });
            ...
            var table=  $('#installmentplan').DataTable({
                ...
                "processing": true,
                "serverSide": true,
                "ajax": '{{ url('expense/dtgetexpenseheads') }}',
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">All Expense Heads</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
            ...
            {{--$('.loaddatabydate').click(function (e) {--}}
                ...
                {{--table.ajax.url("{{url('expense/dtgetexpenseheadsbydate')}}?"+min+'&'+'max='+max).load()--}}
            {{--});--}}
