                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Expenses</h3>
                        </div>
                                        ...
                                        <div class="kt-section__body">
                                            ...
                                            <div class="form-group row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            <select class="form-control kt-select2 selectexpensehead" id="kt_select2_3" name="param">
                                                                <option value="defaultexpensehead" selected disabled>Select Expense Head</option>
                                                                @foreach($expensehead as $expensehea)
                                                                    <option value="{{$expensehea->id}}">{{$expensehea->expense_head}}</option>
                                                                @endforeach
                                                            </select>
                                                ...
                                                <div class="col-md-2" style="margin-top:26px; ">
                                                    <button type=button class=" btn btn-primary btn-receive form-control" data-toggle="modal" data-target="#addexpense">
                                                        Add</button>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
...
{{--                                                        <div class="input-group">--}}
{{--                                                            <input type="text" class="form-control" id="e_name" placeholder="Expense Name">--}}
{{--                                                        </div>--}}
{{--                                                        <span class="form-text error-alert text-danger"></span>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
                                                ...
                                                <div class="col-md-3">
                                                    {{--<div class="form-group">--}}
                                                        ...
                                                        <div class="input-group">
                                                            <textarea class="form-control" id="description" placeholder="Description of Expense"></textarea>
                                                            <span class="form-text error-alert text-danger"></span>
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Expense Head</h5>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" autocomplete="off" class="form-control" id="expense_head" placeholder="Enter Expense Head">
                                    <span class="form-text error-alert text-danger"></span>
                                </div>
                            </div>
                            <div class="col-md-3"></div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary closeehead" data-dismiss="modal">Close</button>
                        <button type="button" class="btn btn-primary saveexpensehead">Submit</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        @section('scripts')
            ...
            <script>
                $(document).ready(function (e) {
                    ...
                    $(".saveexpensehead").click(function (e) {
                        var expensehead=$('#expense_head').val();
                        //validations
                        if (expensehead == '' || expensehead == null) {
                            $('#expense_head').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Expense Head Name is Required.').addClass('text-danger').show();
                        } else {
                            $('#expense_head').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        if ($('.is-invalid').length<1) {

                            $.ajax({
                                url: '{{ url("expense/insert_new_expensehead") }}',
                                type: 'post',
                                data: {
                                    'name': expensehead,
                                  '_token': '{{csrf_token()}}'
                                ...
                                success: function (data) {
                                    ...
                                    $('.selectexpensehead').html('');
                                    $('.selectexpensehead').append('<option value="defaultexpensehead" selected disabled>Select Expense Head</option>');
                                    for(var l=0;l<data.data.length;l++){
                                        $('.selectexpensehead').append('<option value="'+data.data[l].id+'">'+data.data[l].expense_head+'</option>');
                                    }
                            ...
                            $('#expense_head').removeClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                            $('#expense_head').val('');
                        }
                    ...
                    $("#saveexpense").click(function (e) {
                        var expensehead=$('.selectexpensehead').val();
                        ...
                        if (expensehead == 'defaultexpensehead' || expensehead == null) {
                            $('.selectexpensehead').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Expense Head is Required.').addClass('text-danger').show();
                        } else {
                            $('.selectexpensehead').removeClass('is-invalid').addClass('is-valid').closest('div').children('.form-text').text('').addClass('text-danger').hide();
                        }
                        ...
                        if (amount == '' || amount == null) {
                            ...
                            $('#amount').addClass('is-invalid').removeClass('is-valid').closest('div').children('.form-text').text('Not enough amount in Account.').addClass('text-danger').show();
                        }
                        else {
                        ...
                        if ($('.is-invalid').length<1) {
                            ...
                            $.ajax({
                                url: '{{ url("expense/insert_new_expensedetail") }}',
                                type: 'post',
                                data: {
