                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Company</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ajax: "{{ url('product/dtpostcompany') }}",
                table: "#company",
                display: "bootstrap",
                idSrc:'id',
                fields: [
                    ...
                    {'extend': 'print', className: 'm-btn--square  btn-outline-primary',
                        ...
                        title: function(){
                            var printTitle = '' +
                                ...
                                '                                        <h1 class=" mr-2" style="font-family: sans-serif;text-decoration: underline">All Companies</h5>\n' +
                                '                                    </div>\n' +
                                '                                    <div class="col-md-6">\n' +
