...
@section('css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/editor/css/editor.bootstrap4.css') }}">
                ...
                <div class="kt-portlet kt-portlet--last kt-portlet--head-lg kt-portlet--responsive-mobile" id="kt_page_portlet">
                    <div class="kt-portlet__head kt-portlet__head--lg">
                        <div class="kt-portlet__head-label">
                            <h3 class="kt-portlet__head-title">Category</h3>
                        </div>
    ...
    <script>
        ...
        $(document).ready(function (e) {
            ...
            editor =  new $.fn.dataTable.Editor({
                ajax: "{{ url('product/dtpostcategory') }}",
                table: "#company",
                display: "bootstrap",
                idSrc:'id',
                fields: [
            ...
            var table=  $('#company').DataTable({
                dom: "Bfrtip",
                ajax:'{{ url('product/dtgetcategory') }}',
                "processing": true,
                "serverSide": true,
                select: true,
                idSrc:'id',
