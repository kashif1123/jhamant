...
var KTamChartsChartsDemo=function() {
    var e=function() {
            ...
            AmCharts.makeChart("kt_amcharts_13", {
                    type:"pie", theme:"light", dataProvider:[], valueField:"size", titleField:"sector", startDuration:0, innerRadius:80, pullOutRadius:20, marginTop:30, titles:[ {
    ...
    return {
        init:function() {
            AmCharts.makeChart("kt_amcharts_1", {
                    rtl:KTUtil.isRTL(), type:"serial", theme:"light", dataProvider:[ {
                ...
                AmCharts.makeChart("kt_amcharts_3", {
                        theme:"light", type:"serial", dataProvider:[ {
                            ...
                            balloonText: "GDP grow in [[category]] (2004): <b>[[value]]</b>", fillAlphas: .9, lineAlpha: .2, title: "2004", type: "column", valueField: "year2004"
                        }
                            , {
                                balloonText: "GDP grow in [[category]] (2005): <b>[[value]]</b>", fillAlphas: .9, lineAlpha: .2, title: "2005", type: "column", clustered: !1, columnWidth: .5, valueField: "year2005"
                            }
                ...
                AmCharts.makeChart("kt_amcharts_4", {
                        theme:"light", type:"serial", dataProvider:[ {
                            ...
                            stackType: "3d", unit: "%", position: "left", title: "GDP growth rate"
                        }
                        ], startDuration:1, graphs:[ {
                            balloonText: "GDP grow in [[category]] (2004): <b>[[value]]</b>", fillAlphas: .9, lineAlpha: .2, title: "2004", type: "column", valueField: "year2004"
                        }
                            , {
                                balloonText: "GDP grow in [[category]] (2005): <b>[[value]]</b>", fillAlphas: .9, lineAlpha: .2, title: "2005", type: "column", valueField: "year2005"
                            }
                ...
                AmCharts.makeChart("kt_amcharts_5", {
                        ...
                        , dataProvider:[ {
                            ...
                            balloonText: "<span style='font-size:13px;'>[[title]] in [[category]]:<b>[[value]]</b></span>", title: "Income", type: "column", fillAlphas: .8, valueField: "income"
                        }
                            , {
                                balloonText: "<span style='font-size:13px;'>[[title]] in [[category]]:<b>[[value]]</b></span>", bullet: "round", bulletBorderAlpha: 1, bulletColor: "#FFFFFF", useLineColorForBulletBorder: !0, fillAlphas: 0, lineThickness: 2, lineAlpha: 1, bulletSize: 7, title: "Expenses", valueField: "expenses"
                            }
                ...
                function() {
                    var e=AmCharts.makeChart("kt_amcharts_6", {
                            type:"serial", theme:"light", marginRight:40, marginLeft:40, autoMarginOffset:20, mouseWheelZoomEnabled:!0, dataDateFormat:"YYYY-MM-DD", valueAxes:[ {
                            ...
                            , graphs:[ {
                                ...
                                , bullet:"round", bulletBorderAlpha:1, bulletColor:"#FFFFFF", bulletSize:5, hideBulletsCount:50, lineThickness:2, title:"red line", useLineColorForBulletBorder:!0, valueField:"value", balloonText:"<span style='font-size:18px;'>[[value]]</span>"
                            }
                            ], chartScrollbar: {
                                graph: "g1", oppositeAxis: !1, offset: 30, scrollbarHeight: 80, backgroundAlpha: 0, selectedBackgroundAlpha: .1, selectedBackgroundColor: "#888888", graphFillAlpha: 0, graphLineAlpha: .5, selectedGraphFillAlpha: 0, selectedGraphLineAlpha: 1, autoGridCount: !0, color: "#AAAAAA"
                            }
                            , chartCursor: {
                                pan: !0, valueLineEnabled: !0, valueLineBalloonEnabled: !0, cursorAlpha: 1, cursorColor: "#258cbb", limitToGraph: "g1", valueLineAlpha: .2, valueZoomable: !0
                            }
                            , valueScrollbar: {
                ...
                function() {
                    var e=function() {
                        ...
                        a=AmCharts.makeChart("kt_amcharts_7", {
                                type:"serial", theme:"light", marginRight:80, autoMarginOffset:20, marginTop:7, dataProvider:e, valueAxes:[ {
                                    axisAlpha: .2, dashLength: 1, position: "left"
                                }
                                ], mouseWheelZoomEnabled:!0, graphs:[ {
                                    id:"g1", balloonText:"[[value]]", bullet:"round", bulletBorderAlpha:1, bulletColor:"#FFFFFF", hideBulletsCount:50, title:"red line", valueField:"visits", useLineColorForBulletBorder:!0, balloon: {
                                        drop: !0
                                    }
                                }
                                ], chartScrollbar: {
                ...
                AmCharts.makeChart("kt_amcharts_8", {
                        ...
                        , dataProvider:[ {
                            ...
                            categoryBalloonDateFormat: "DD", cursorAlpha: .1, cursorColor: "#000000", fullWidth: !0, valueBalloonsEnabled: !1, zoomable: !1
                        }
                        , dataDateFormat:"YYYY-MM-DD", categoryField:"date", categoryAxis: {
                            ...
                            ], parseDates:!0, autoGridCount:!1, axisColor:"#555555", gridAlpha:.1, gridColor:"#FFFFFF", gridCount:50
                        }
                        , export: {
                            enabled: !0
                        }
                ...
                AmCharts.makeChart("kt_amcharts_9", {
                        type:"radar", theme:"light", dataProvider:[ {
                            ...
                            balloonText: "[[value]] litres of beer per year", bullet: "round", lineThickness: 2, valueField: "litres"
                        }
                ...
                AmCharts.makeChart("kt_amcharts_11", {
                        ...
                        , graphs:[ {
                            title: "Trial #1", balloonText: "[[category]]: [[value]] m/s", bullet: "round", lineAlpha: 0, series: [[83, 5.1], [44, 5.8], [76, 9], [2, 1.4], [100, 8.3], [96, 1.7], [68, 3.9], [0, 3], [100, 4.1], [16, 5.5], [71, 6.8], [100, 7.9], [9, 6.8], [85, 8.3], [51, 6.7], [95, 3.8], [95, 4.4], [1, .2], [107, 9.7], [50, 4.2], [42, 9.2], [35, 8], [44, 6], [64, .7], [53, 3.3], [92, 4.1], [43, 7.3], [15, 7.5], [43, 4.3], [90, 9.9]]
                        }
                            , {
                                title: "Trial #2", balloonText: "[[category]]: [[value]] m/s", bullet: "round", lineAlpha: 0, series: [[178, 1.3], [129, 3.4], [99, 2.4], [80, 9.9], [118, 9.4], [103, 8.7], [91, 4.2], [151, 1.2], [168, 5.2], [168, 1.6], [152, 1.2], [149, 3.4], [182, 8.8], [106, 6.7], [111, 9.2], [130, 6.3], [147, 2.9], [81, 8.1], [138, 7.7], [107, 3.9], [124, .7], [130, 2.6], [86, 9.2], [169, 7.5], [122, 9.9], [100, 3.8], [172, 4.1], [140, 7.3], [161, 2.3], [141, .9]]
                            }
                            , {
                                title: "Trial #3", balloonText: "[[category]]: [[value]] m/s", bullet: "round", lineAlpha: 0, series: [[419, 4.9], [417, 5.5], [434, .1], [344, 2.5], [279, 7.5], [307, 8.4], [279, 9], [220, 8.4], [204, 8], [446, .9], [397, 8.9], [351, 1.7], [393, .7], [254, 1.8], [260, .4], [300, 3.5], [199, 2.7], [182, 5.8], [173, 2], [201, 9.7], [288, 1.2], [333, 7.4], [308, 1.9], [330, 8], [408, 1.7], [274, .8], [296, 3.1], [279, 4.3], [379, 5.6], [175, 6.8]]
                            }
                        ], export: {
                            enabled: !0
                        }
